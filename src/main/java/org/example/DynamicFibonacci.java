...
/*
Просторова О(n) в найгіршому випадку оскільки є пул значень в хешмапі
Часова О(n) оскільки є пул чисел фібоначчі і таким чином кожне число обчисоюється тільки один раз
 */
